...
namespace CrossFunctionOverrides
{
    public class Function
    {
        ...
        private IModelStore<CrossFunctionOverridesInputs> store;

        public async Task<CrossFunctionOverridesOutputs> Handler(CrossFunctionOverridesInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<CrossFunctionOverridesInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<CrossFunctionOverridesInputs,CrossFunctionOverridesOutputs>(store, CrossFunctionOverrides.Execute);
